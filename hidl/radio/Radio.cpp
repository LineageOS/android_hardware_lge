...
Radio::Radio(sp<::lineage::hardware::radio::V1_0::IRadio> realRadio, int slotId) : mRealRadio(realRadio) {
    mSlotId = slotId;
}
...
Return<void> Radio::setResponseFunctions(const sp<V1_0::IRadioResponse>& radioResponse,
    ...
    mRadioResponse->setRealRadioResponse(radioResponse);
    mRadioIndication->setRealRadioIndication(radioIndication);
    ...
    WRAP_V1_0_CALL(
            ...
            reinterpret_cast<sp<::lineage::hardware::radio::V1_0::IRadioResponse>&>(mRadioResponse),
            reinterpret_cast<sp<::lineage::hardware::radio::V1_0::IRadioIndication>&>(
                    mRadioIndication));
}
...
Return<void> Radio::dial(int32_t serial, const V1_0::Dial& dialInfo) {
    WRAP_V1_0_CALL(dial, serial, convert(dialInfo));
}
...
Return<void> Radio::sendSms(int32_t serial, const V1_0::GsmSmsMessage& message) {
    WRAP_V1_0_CALL(sendSms, serial, convert(message));
}

Return<void> Radio::sendSMSExpectMore(int32_t serial, const V1_0::GsmSmsMessage& message) {
    WRAP_V1_0_CALL(sendSMSExpectMore, serial, convert(message));
}
...
Return<void> Radio::setupDataCall(int32_t serial, V1_0::RadioTechnology radioTechnology,
    ...
    WRAP_V1_0_CALL(setupDataCall, serial, convert(radioTechnology), convert(dataProfileInfo),
                   modemCognitive, roamingAllowed, isRoaming);
}

Return<void> Radio::iccIOForApp(int32_t serial, const V1_0::IccIo& iccIo) {
    WRAP_V1_0_CALL(iccIOForApp, serial, convert(iccIo));
}
...
Return<void> Radio::getCallForwardStatus(int32_t serial, const V1_0::CallForwardInfo& callInfo) {
    WRAP_V1_0_CALL(getCallForwardStatus, serial, convert(callInfo));
}

Return<void> Radio::setCallForward(int32_t serial, const V1_0::CallForwardInfo& callInfo) {
    WRAP_V1_0_CALL(setCallForward, serial, convert(callInfo));
}
...
Return<void> Radio::acknowledgeLastIncomingGsmSms(int32_t serial, bool success,
    ...
    WRAP_V1_0_CALL(acknowledgeLastIncomingGsmSms, serial, success, convert(cause));
}
...
Return<void> Radio::writeSmsToSim(int32_t serial, const V1_0::SmsWriteArgs& smsWriteArgs) {
    WRAP_V1_0_CALL(writeSmsToSim, serial, convert(smsWriteArgs));
}
...
Return<void> Radio::setBandMode(int32_t serial, V1_0::RadioBandMode mode) {
    WRAP_V1_0_CALL(setBandMode, serial, convert(mode));
}
...
Return<void> Radio::setPreferredNetworkType(int32_t serial, V1_0::PreferredNetworkType nwType) {
    WRAP_V1_0_CALL(setPreferredNetworkType, serial, convert(nwType));
}
...
Return<void> Radio::setCdmaSubscriptionSource(int32_t serial,
    ...
    WRAP_V1_0_CALL(setCdmaSubscriptionSource, serial, convert(cdmaSub));
}

Return<void> Radio::setCdmaRoamingPreference(int32_t serial, V1_0::CdmaRoamingType type) {
    WRAP_V1_0_CALL(setCdmaRoamingPreference, serial, convert(type));
}
...
Return<void> Radio::setTTYMode(int32_t serial, V1_0::TtyMode mode) {
    WRAP_V1_0_CALL(setTTYMode, serial, convert(mode));
}
...
Return<void> Radio::sendCdmaSms(int32_t serial, const V1_0::CdmaSmsMessage& sms) {
    WRAP_V1_0_CALL(sendCdmaSms, serial, convert(sms));
}

Return<void> Radio::acknowledgeLastIncomingCdmaSms(int32_t serial, const V1_0::CdmaSmsAck& smsAck) {
    WRAP_V1_0_CALL(acknowledgeLastIncomingCdmaSms, serial, convert(smsAck));
}
...
Return<void> Radio::setGsmBroadcastConfig(
    ...
    WRAP_V1_0_CALL(setGsmBroadcastConfig, serial, convert(configInfo));
}
...
Return<void> Radio::setCdmaBroadcastConfig(
    ...
    WRAP_V1_0_CALL(setCdmaBroadcastConfig, serial, convert(configInfo));
}
...
Return<void> Radio::writeSmsToRuim(int32_t serial, const V1_0::CdmaSmsWriteArgs& cdmaSms) {
    WRAP_V1_0_CALL(writeSmsToRuim, serial, convert(cdmaSms));
}
...
Return<void> Radio::setInitialAttachApn(int32_t serial,
    ...
    WRAP_V1_0_CALL(setInitialAttachApn, serial, convert(dataProfileInfo), modemCognitive,
                   isRoaming);
}
...
Return<void> Radio::sendImsSms(int32_t serial, const V1_0::ImsSmsMessage& message) {
    WRAP_V1_0_CALL(sendImsSms, serial, convert(message));
}

Return<void> Radio::iccTransmitApduBasicChannel(int32_t serial, const V1_0::SimApdu& message) {
    WRAP_V1_0_CALL(iccTransmitApduBasicChannel, serial, convert(message));
}
...
Return<void> Radio::iccTransmitApduLogicalChannel(int32_t serial, const V1_0::SimApdu& message) {
    WRAP_V1_0_CALL(iccTransmitApduLogicalChannel, serial, convert(message));
}

Return<void> Radio::nvReadItem(int32_t serial, V1_0::NvItem itemId) {
    WRAP_V1_0_CALL(nvReadItem, serial, convert(itemId));
}

Return<void> Radio::nvWriteItem(int32_t serial, const V1_0::NvWriteItem& item) {
    WRAP_V1_0_CALL(nvWriteItem, serial, convert(item));
}
...
Return<void> Radio::nvResetConfig(int32_t serial, V1_0::ResetNvType resetType) {
    WRAP_V1_0_CALL(nvResetConfig, serial, convert(resetType));
}

Return<void> Radio::setUiccSubscription(int32_t serial, const V1_0::SelectUiccSub& uiccSub) {
    WRAP_V1_0_CALL(setUiccSubscription, serial, convert(uiccSub));
}
...
Return<void> Radio::setDataProfile(int32_t serial, const hidl_vec<V1_0::DataProfileInfo>& profiles,
                                   bool isRoaming) {
    WRAP_V1_0_CALL(setDataProfile, serial, convert(profiles), isRoaming);
}
...
Return<void> Radio::setRadioCapability(int32_t serial, const V1_0::RadioCapability& rc) {
    WRAP_V1_0_CALL(setRadioCapability, serial, convert(rc));
}
...
Return<void> Radio::setAllowedCarriers(int32_t serial, bool allAllowed,
    ...
    WRAP_V1_0_CALL(setAllowedCarriers, serial, allAllowed, convert(carriers));
}
...
Return<void> Radio::sendDeviceState(int32_t serial, V1_0::DeviceStateType deviceStateType,
                                    bool state) {
    WRAP_V1_0_CALL(sendDeviceState, serial, convert(deviceStateType), state);
}
...
Return<void> Radio::setCarrierInfoForImsiEncryption(
    ...
    MAYBE_WRAP_V1_1_CALL(setCarrierInfoForImsiEncryption, serial, convert(imsiEncryptionInfo));
...
Return<void> Radio::setSimCardPower_1_1(int32_t serial, V1_1::CardPowerState powerUp) {
    MAYBE_WRAP_V1_1_CALL(setSimCardPower_1_1, serial, convert(powerUp));

    if (powerUp != V1_1::CardPowerState::POWER_UP_PASS_THROUGH)
        WRAP_V1_0_CALL(setSimCardPower, serial, powerUp != V1_1::CardPowerState::POWER_DOWN);

    return Void();
}

Return<void> Radio::startNetworkScan(int32_t serial, const V1_1::NetworkScanRequest& request) {
    MAYBE_WRAP_V1_1_CALL(startNetworkScan, serial, convert(request));
...
Return<void> Radio::startKeepalive(int32_t serial, const V1_1::KeepaliveRequest& keepalive) {
    MAYBE_WRAP_V1_1_CALL(startKeepalive, serial, convert(keepalive));
...
Return<void> Radio::startNetworkScan_1_2(int32_t serial, const V1_2::NetworkScanRequest& request) {
    MAYBE_WRAP_V1_2_CALL(startNetworkScan_1_2, serial, convert(request));
...
Return<void> Radio::setSignalStrengthReportingCriteria(int32_t serial, int32_t hysteresisMs,
    ...
    MAYBE_WRAP_V1_2_CALL(setSignalStrengthReportingCriteria, serial, hysteresisMs, hysteresisDb,
                         thresholdsDbm, convert(accessNetwork));
...
Return<void> Radio::setupDataCall_1_2(int32_t serial, V1_2::AccessNetwork accessNetwork,
    ...
    MAYBE_WRAP_V1_2_CALL(setupDataCall_1_2, serial, convert(accessNetwork),
                         convert(dataProfileInfo), modemCognitive, roamingAllowed, isRoaming,
                         convert(reason), addresses, dnses);
...
Return<void> Radio::deactivateDataCall_1_2(int32_t serial, int32_t cid,
                                           V1_2::DataRequestReason reason) {
    MAYBE_WRAP_V1_2_CALL(deactivateDataCall_1_2, serial, cid, convert(reason));
...
Return<void> Radio::setSystemSelectionChannels(
    ...
    MAYBE_WRAP_V1_3_CALL(setSystemSelectionChannels, serial, specifyChannels, convert(specifiers));
...
Return<void> Radio::setupDataCall_1_4(int32_t serial, V1_4::AccessNetwork accessNetwork,
                                      ...
                                      const hidl_vec<hidl_string>& addresses,
                                      const hidl_vec<hidl_string>& dnses) {
    MAYBE_WRAP_V1_4_CALL(setupDataCall_1_4, serial, convert(accessNetwork),
                         convert(dataProfileInfo), roamingAllowed, convert(reason), addresses,
                         dnses);

    V1_0::DataProfileInfo V1_0DataProfileInfo = Get1_0DataProfileInfo(dataProfileInfo);

    MAYBE_WRAP_V1_2_CALL(setupDataCall_1_2, serial,
                         convert((static_cast<V1_2::AccessNetwork>(accessNetwork))),
                         convert(V1_0DataProfileInfo), dataProfileInfo.persistent, roamingAllowed,
                         mRadioResponse->getDataRoaming(), convert(reason), addresses, dnses);

    WRAP_V1_0_CALL(setupDataCall, serial, convert(mRadioResponse->getRadioTechnology()),
                   convert(V1_0DataProfileInfo), dataProfileInfo.persistent, roamingAllowed,
                   mRadioResponse->getDataRoaming());
}

Return<void> Radio::setInitialAttachApn_1_4(int32_t serial,
                                            const V1_4::DataProfileInfo& dataProfileInfo) {
    MAYBE_WRAP_V1_4_CALL(setInitialAttachApn_1_4, serial, convert(dataProfileInfo));

    V1_0::DataProfileInfo V1_0DataProfileInfo = Get1_0DataProfileInfo(dataProfileInfo);

    WRAP_V1_0_CALL(setInitialAttachApn, serial, convert(V1_0DataProfileInfo),
                   dataProfileInfo.persistent, mRadioResponse->getDataRoaming());
}

Return<void> Radio::setDataProfile_1_4(int32_t serial,
                                       const hidl_vec<V1_4::DataProfileInfo>& profiles) {
    MAYBE_WRAP_V1_4_CALL(setDataProfile_1_4, serial, convert(profiles));
    ...
    auto legacyProfilesHidl = hidl_vec<V1_0::DataProfileInfo>(legacyProfiles);

    if (legacyProfiles.size()) {
        WRAP_V1_0_CALL(setDataProfile, serial, convert(legacyProfilesHidl),
                       mRadioResponse->getDataRoaming());
    }
...
Return<void> Radio::emergencyDial(int32_t serial, const V1_0::Dial& dialInfo,
    ...
    MAYBE_WRAP_V1_4_CALL(emergencyDial, serial, convert(dialInfo), categories, urns,
                         convert(routing), hasKnownUserIntentEmergency, isTesting);
...
Return<void> Radio::startNetworkScan_1_4(int32_t serial, const V1_2::NetworkScanRequest& request) {
    MAYBE_WRAP_V1_4_CALL(startNetworkScan_1_4, serial, convert(request));
    ...
    MAYBE_WRAP_V1_1_CALL(startNetworkScan, serial, convert(legacyRequest));
...
Return<void> Radio::setAllowedCarriers_1_4(int32_t serial,
    ...
    MAYBE_WRAP_V1_4_CALL(setAllowedCarriers_1_4, serial, convert(carriers),
                         convert(multiSimPolicy));
    ...
    if (supported) {
        ...
        WRAP_V1_0_CALL(setAllowedCarriers, serial, isAllCarriersAllowed, convert(legacyCarriers));
    }
...
sp<::lineage::hardware::radio::V1_1::IRadio> Radio::getRealRadio_V1_1() {
    return ::lineage::hardware::radio::V1_1::IRadio::castFrom(mRealRadio).withDefault(nullptr);
}

sp<::lineage::hardware::radio::V1_2::IRadio> Radio::getRealRadio_V1_2() {
    return ::lineage::hardware::radio::V1_2::IRadio::castFrom(mRealRadio).withDefault(nullptr);
}

sp<::lineage::hardware::radio::V1_3::IRadio> Radio::getRealRadio_V1_3() {
    return ::lineage::hardware::radio::V1_3::IRadio::castFrom(mRealRadio).withDefault(nullptr);
}

sp<::lineage::hardware::radio::V1_4::IRadio> Radio::getRealRadio_V1_4() {
    return ::lineage::hardware::radio::V1_4::IRadio::castFrom(mRealRadio).withDefault(nullptr);
}
