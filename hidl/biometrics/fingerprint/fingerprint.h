...
typedef enum fingerprint_lge_extra_cmd {
    FINGERPRINT_LGE_SCAN_START = 0,
    FINGERPRINT_LGE_SCAN_STOP = 1,
    FINGERPRINT_LGE_NAVIGATION_START = 2,
    FINGERPRINT_LGE_NAVIGATION_STOP = 3,
} fingerprint_lge_extra_cmd_t;
...
typedef struct fingerprint_device {
    ...
    /*
    * Extended function implemented by LGE.
    */
    int (*authenticate_ex)(struct fingerprint_device * dev, uint32_t gid, uint8_t * challenge, uint64_t challengeSize, uint32_t flags);

    /*
    * Extended function implemented by LGE.
    */
    int (*cancel_ex)(struct fingerprint_device * dev);

#ifdef LGE_EGISTEC_UDFPS
    /*
     * Extended API functionality implemented by LGE.
     * Param is a 4-byte array
     *
     */
    int (*do_extra_api_in)(fingerprint_lge_extra_cmd_t cmd, uint32_t * param);
