...
int main() {
    ...
    // AIDL frontend
    sp<ColorEnhancement> ce = ndk::SharedRefBase::make<ColorEnhancement>();
    sp<DisplayModes> dm = ndk::SharedRefBase::make<DisplayModes>();
    sp<SunlightEnhancement> se = ndk::SharedRefBase::make<SunlightEnhancement>();
    sp<PictureAdjustment> pa = ndk::SharedRefBase::make<PictureAdjustment>(controller);
