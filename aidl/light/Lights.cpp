...
void Lights::setLightLocked(const LightState& state) {
    int onMS, offMS;
    uint32_t color;
...
void Lights::handleAttention(const LightState& state) {
    mAttentionState = state;
    checkLightStateLocked();
}

void Lights::handleBattery(const LightState& state) {
    mBatteryState = state;
    checkLightStateLocked();
}

void Lights::handleNotifications(const LightState& state) {
    mNotificationState = state;
    checkLightStateLocked();
}
#endif // LED

void Lights::handleBacklight(const LightState& state) {
