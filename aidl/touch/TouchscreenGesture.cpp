...
// Use Soong-configurable paths with fallbacks
#ifndef GESTURE_AVAILABLE_PATH
#define GESTURE_AVAILABLE_PATH "/sys/devices/virtual/input/lge_touch/swipe_available"
#endif

#ifndef GESTURE_ENABLE_PATH
#define GESTURE_ENABLE_PATH "/sys/devices/virtual/input/lge_touch/swipe_enable"
#endif

const std::string kAvailableGesturePath = GESTURE_AVAILABLE_PATH;
const std::string kGesturePath = GESTURE_ENABLE_PATH;
